...
const AuthForm = ({ mode, onSubmit }) => {
  ...
  return (
    <form
      class="space-y-6 bg-gray-50 p-6 rounded-lg shadow-md"
    ...
    >
      ...
      <button
        type=""
        class="w-full bg-primary-color text-white py-3 rounded-lg hover:bg-secondary-color transition duration-300 hover:text-[#FF5A5F]"
      >
        {mode === "login" ? "로그인" : "회원가입"}
      </button>
    </form>
